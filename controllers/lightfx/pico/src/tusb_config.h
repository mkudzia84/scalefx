/*
 * TinyUSB Configuration for lightfx_pico
...
// lightfx_pico USB Identifiers
#define USB_VID                    0x2e8a  // Raspberry Pi Foundation
#define USB_PID                    0x0181  // lightfx_pico (community range 0x0100-0x01FF)

// Device descriptor strings
#define USB_MANUFACTURER            "MSB (Marcin Scale Builds)"
#define USB_PRODUCT_NAME            "LightFX"
