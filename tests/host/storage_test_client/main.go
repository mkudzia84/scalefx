// Storage Test Client — Drives tests/hw/storage_test/ firmware over USB-serial
...
//
// Rule 21: this lives in tests/host/ and `replace scalefx => ../../../app/go`
// lets us reach into the in-tree Go SDK without publishing it.
package main
