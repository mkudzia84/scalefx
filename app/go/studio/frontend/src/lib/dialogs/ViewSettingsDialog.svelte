...
<script lang="ts">
    ...
    // The AI assistant is configured in the standalone service now (provider
    // tokens + model routing live there); the model is chosen in the Assistant
    // dock.  Nothing assistant-related remains in Settings.
