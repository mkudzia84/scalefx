...
Authoritative rules with full rationale + examples: [.github/copilot-instructions.md](.github/copilot-instructions.md) (Rules 0–61). Below is the compact index — **same rule numbers**, one line each. When this conflicts with copilot-instructions.md, that file wins. Architecture overview: [32-ARCHITECTURE-DIAGRAMS.md](instructions/32-ARCHITECTURE-DIAGRAMS.md).
